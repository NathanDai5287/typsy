  ...
  const endSession = useCallback(async () => {
    ...
    try {
      ...
      if (localMode !== 'flow') {
        ...
        void queryClient.invalidateQueries({
          queryKey: ['bigramWordTimes', activeProgress.layout_id],
        });
        return;
      }
  ...
  return (
    <div className="flex flex-col items-center px-4 py-6 select-none">
      ...
      {/* Typing area — fixed-height 3-line window that scrolls
          ...
          The whole-page blur + "Press Enter to focus" affordance shown
          while the navbar layer is active is rendered by the App shell. */}
      <div
